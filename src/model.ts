...
function _find(control: AbstractControl, path: Array<string | number> | string, delimiter: string) {
  ...
  return (<Array<string | number>>path).reduce((v: AbstractControl, name): any => {
...
export abstract class AbstractControl {
  ...
  markAsPending(opts: { onlySelf?: boolean; emitEvent?: boolean } = {}): void {
    ...
    if (opts.emitEvent !== false) {
      ;((this.statusChanges as any) as EventEmitter<any>).emit(this.status)
    }
  ...
  disable(opts: { onlySelf?: boolean; emitEvent?: boolean } = {}): void {
    ...
    if (opts.emitEvent !== false) {
      ;((this.valueChanges as any) as EventEmitter<any>).emit(this.value)
      ;((this.statusChanges as any) as EventEmitter<string>).emit(this.status)
    }
  ...
  /** @internal */
  _initObservables() {
    ;(this as { valueChanges: Observable<any> }).valueChanges = new EventEmitter() as any
    ;(this as { statusChanges: Observable<any> }).statusChanges = new EventEmitter() as any
  }
